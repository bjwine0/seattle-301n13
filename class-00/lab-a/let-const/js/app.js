...
function displayPics(){
  ...
  // The variable declared with let is scoped within the while loops block of code.  Trying to console log the variable rando outside this block of code will return undefined since its outside the scope of that block of code.
  console.log(viewed);
