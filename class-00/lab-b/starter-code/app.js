...
// Student is not a constructor error
console.log(joe);
...
//Arrow functions do not bind 'this', so the scope of the function bubbles up to the next nearest enclosing function which is the global window object.
